function [result] = calibration(Bit,Vip,Vin,Vref,Vcm,M,L,Cm_p,Cm_n,Cl_p,Cl_n,Cd1_p,Cd1_n,Cd2_p,Cd2_n,Ca_p,Ca_n,Cp1_p,Cp1_n,Cp2_p,Cp2_n,Cp3_p,Cp3_n,Comp_os,del_Compvn,del_ktc_p,del_ktc_n,Wda,WLda) % calibration model
L_real=5; %%低位的实际位数
